$(function() {
    ...
    window.hotSwap = function(page, pushState) {
        ...
        // Show loading state
        $('main').html('<div class="loading" style="text-align: center; padding: 3rem;">' +
        ...
        // Make the request
        $.get("/get_page", requestParams, function(data) {
            $('main').html(data);
    ...
    function initializeEventSource() {
        ...
        window.statsSource.onerror = function(e) {
            ...
            setTimeout(function() {
                if (window.statsSource && window.statsSource.readyState === EventSource.CLOSED) {
