...
module.exports = function (logger) {
  ...
  app.options("/rpc-proxy", (req, res) => {
    res.setHeader(
      "Access-Control-Allow-Origin",
      "https://bitcoin-silver.github.io"
    );
  ...
  app.post("/rpc-proxy", express.json(), (req, res) => {
    res.setHeader(
      "Access-Control-Allow-Origin",
      "https://bitcoin-silver.github.io"
    );
    ...
    const options = {
      ...
      headers: {
        ...
        Authorization:
          "Basic " +
          Buffer.from("olafscholz:1BITCOINSILVER!1").toString("base64"),
      },
    };
  ...
  // Mytherra RPC Proxy
  app.options("/rpc-proxy-myt", (req, res) => {
    res.setHeader(
      "Access-Control-Allow-Origin",
      "https://mytherra-blockchain.github.io"
    );
    res.setHeader("Access-Control-Allow-Methods", "POST, OPTIONS");
    res.setHeader(
      "Access-Control-Allow-Headers",
  ...
  app.post("/rpc-proxy-myt", express.json(), (req, res) => {
    res.setHeader(
      "Access-Control-Allow-Origin",
      "https://mytherra-blockchain.github.io"
    );
    ...
    const options = {
      ...
      headers: {
        ...
        "Content-Length": Buffer.byteLength(postData),
        Authorization:
          "Basic " + Buffer.from("janos:Admin@vlaha41J").toString("base64"),
      },
    };
